...
class PageController{
  ...
  function renderResponse() {
    ...
    $this->display_options['action']
      ? $action = $this->display_options['action'] 
      : $action = $this->current_action;

    $this->display_options['controller']
      ? $view_name = $this->getViewNameFor($this->display_options['controller'], $action)
