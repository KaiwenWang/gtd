...
class Render{
    ...
    function field( $obj,$field_name,$search_criteria = array(),$new_object_index = 0){
        ...
        if(isset($search_criteria['field_type'])){
            $field_type = $search_criteria['field_type'];
            unset($search_criteria['field_type']);
        } else {
        ...
        if(isset($search_criteria['active'])){
            $tokens['active'] = $search_criteria['active'];
            unset($search_criteria['active']);  
        }
