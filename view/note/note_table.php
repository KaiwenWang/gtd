...
function noteTable( $notes, $o = array()){
    ...
    $html = $r->view( 'basicTable', $table, array('title'=>'Notes  <a class="button ui-state-default ui-corner-all"><span class="ui-icon ui-icon-triangle-1-s"></span></a>','id'=>'note-table'));
    return $html;
}
?>
